...
{
	DB_OK,                  // 正常
	DB_ERR_OPEN_DB,         // 打开数据库失败
	DB_ERR_CREATE_DB,       // 创建数据库失败
	DB_ERR_CREATE_TBL,      // 创建数据表失败
	DB_ERR_DB_NO_EXIST,     // 数据库不存在
	DB_ERR_TBL_NO_EXIST,    // 数据表不存在
	DB_ERR_IDX_NO_EXIST,    // 索引不存在
} db_error_t;
