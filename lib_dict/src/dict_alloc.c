...
static const char *dict_default_lookup(DICT *dict, char *key acl_unused, size_t key_len acl_unused,
			char **value acl_unused, size_t *size acl_unused)
{
...
static void dict_default_update(DICT *dict, char *key acl_unused, size_t key_len acl_unused,
		char *value acl_unused, size_t len acl_unused)
{
...
static int dict_default_delete(DICT *dict, char *key acl_unused, size_t key_len acl_unused)
{
