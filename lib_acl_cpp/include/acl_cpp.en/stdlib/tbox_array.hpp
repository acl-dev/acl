...
public:
	/**
	 * Constructor
	 * @param free_obj {bool} When tbox_array is destroyed, whether to automatically check and release
	...
	/**
	 * Send message object. This process unlocks first then notifies after adding object
