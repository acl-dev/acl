...
public:
	...
	/**
	 * Subclasses implement this interface to get query results. If res.ips_.size()
	 * == 0,
	 ...
	 * Note: In this callback, dns_service object must not be deleted, otherwise it
	 * will cause
...
public:
	 ...
	 * @param callback {dns_result_callback*} When resolution is complete, callback
	 * this class's
	...
	/**
	 * When query thread completes domain name resolution, it will notify the query
	 * object in main thread. The query object will
